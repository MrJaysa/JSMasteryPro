  ...
  return (
    ...
    >
      <div className="container relative" ref={parallaxRef}>
        <div className="relative z-1 mx-auto mb-[3.825rem] max-w-[62rem] text-center md:mb-20 lg:mb-[6.25rem]">
            ...
            <div className="relative rounded-[1rem] bg-n-8">
              ...
              <div className="aspect-[33/40] overflow-hidden rounded-b-[0.9rem] md:aspect-[688/490] lg:aspect-[1024/490]">
                <img
                  src={robot}
                  alt="Robot AI"
                  className="lg:-translate-y-23% w-full translate-y-[8%] scale-[1.7] md:-translate-y-[10%] md:scale-[1]"
                />
